...
This is the test suite for the DemoBlaze application, featuring scenarios covering key functionalities such as purchasing products, managing the shopping cart, and scraping product information.
...
**Note:** The tests are included in the `/scenarios` folder of the project.
